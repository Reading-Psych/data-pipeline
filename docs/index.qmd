...
![Flow diagram showing participant moving from one platform to another. We will use this as the basic paradigm and then describe variations later.](images/Figure_1_1.png){#fig-1.1}

![Flow diagram to show how URL parameters take information from one platform to the next.](images/Figure_1_2.png){#fig-1.2}

# 2       Things you need before you build the pipeline

You will need a SONA account. Details are [here](#further_details_sona).

You will need a REDCap account. Details are [here](#further_details_redcap).

You will need a Gorilla account (assuming you are setting up the pipeline above, which will run an experiment on Gorilla). Details are [here](#set_up_gorilla_account_and_expt).
...
Details of setting up a new REDCap project are [here.](#set_up_redcap_project)
...
Full details about adding an Information Sheet and Consent form to your project (including a template you can download) are [here.](#adding_pis_consent)
...
![Finding the public survey URL for your consent form in REDCap](images/Figure_4_1.png){#fig-4.1}

Assuming that you have a SONA account (if not, see [Section](#_Things_you_need) above), log in and choose 'Add a new study':

![Adding a new SONA study](images/Figure_4_2.png){#fig-4.2}

Follow the instructions on this page (choosing the credited option of 'external online study' as the type of study):

![Setting up your study on SONA](images/Figure_4_3.png){#fig-4.3}
...
![where to paste REDCap URL in SONA](images/Figure_4_4.png){#fig-4.4}
...
If you are interested in the details of what the URL means, or how to recognise URLs from different platforms, see [here](#recognising_urls).

# 5       Finding the right URL from Gorilla to allow REDCap to pass it a participant ID

When you [set up a study in Gorilla,](#set_up_gorilla_account_and_expt) it allows you to set up a recruitment policy which tells Gorilla where participants are coming from. Gorilla will then help correctly configure its study URL accordingly.  
...
See *'Figure 14  to find the finish node in your gorilla experiment'* for where to find the finish node. Click 'edit' and then click on the 'finish node' and then click 'remove'.
...
![](file:////Users/nt906822/Library/Group%2520Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image036.png)Figure 21 - Testing that participant's SONA ID has passed to REDCap consent form
...
![](file:////Users/nt906822/Library/Group%2520Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image030.png)Figure 22 - Testing gorilla experiment with test participant ID
...
 [\[AH1\]](#_msoanchor_1)Do you have a URL for this?

 [\[AH2\]](#_msoanchor_2)Or should we have this as an appendix if it's a word file template?

 [\[BW3\]](#_msoanchor_3)Added, it's a zip file so may be a little difficult in a word doc; Online should be easy to link this ☺️
