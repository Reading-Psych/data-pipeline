...
![Flow diagram showing participant moving from one platform to another. We will use this as the basic paradigm and then describe variations later.](images/1_1.png){#fig-1.1}
...
Figure 38 -- Prolific -- settings to address how participants are paid in response to their complet
...
Figure 39 - Finding the online designer in REDCap
...
[Figure 1 - Flow diagram showing participant moving from one platform to another. We will use this as the basic paradigm and then describe variations later. 2](#_Toc135308282)

[Figure 2 -Flow diagram to show how URL parameters take information from one platform to the next. 2](#_Toc135308283)

[Figure 3 - Finding the public survey URL for your consent form in REDCap. 4](#_Toc135308284)

[Figure 4 - Adding a new SONA study. 4](#_Toc135308285)

[Figure 5 -- Setting up your study on SONA. 4](#_Toc135308286)

[Figure 6- where to paste REDCap URL in SONA. 5](#_Toc135308287)

[Figure 7 - Setting the recruitment policy in gorilla. 5](#_Toc135308288)

[Figure 8 - Changing recruitment policy in gorilla to SONA. 6](#_Toc135308289)

[Figure 9 - Finding correct URL for your gorilla experiment 6](#_Toc135308290)

[Figure 10 - Finding the REDCap survey redirection settings. 7](#_Toc135308291)

[Figure 11 - Pasting the gorilla experiment URL into REDCap. 8](#_Toc135308292)

[Figure 12 - Ensuring gorilla URL has edited '\[ppt_id\]' when pasting into REDCap. 8](#_Toc135308293)

[Figure 13 - Finding SONA redirect link for automatic crediting. 9](#_Toc135308294)

[Figure 14 - Finding the 'finish' node in gorilla. 10](#_Toc135308295)

[Figure 15 - Pasting SONA completion URL in gorilla 'finish' node. 10](#_Toc135308296)

[Figure 16 - Participant view of successful automatic SONA crediting upon study completion. 11](#_Toc135308297)

[Figure 17 - Removing the finish node in gorilla. 12](#_Toc135308298)

[Figure 18 - Adding a 'reject' node in gorilla. 12](#_Toc135308299)

[Figure 19 - Adding the SONA completion link as the onward URL in gorilla reject node for testing  13](#_Toc135308300)

[Figure 20 - Finding SONA's sample link for testing pipeline with dummy participant ID.. 13](#_Toc135308301)

[Figure 21 - Testing that participant's SONA ID has passed to REDCap consent form.. 14](#_Toc135308302)

[Figure 22 - Testing gorilla experiment with test participant ID. 15](#_Toc135308303)

[Figure 23 - Successful testing of automatic SONA crediting. 15](#_Toc135308304)

[Figure 24 - Checking your test data entry on REDCap. 16](#_Toc135308305)

[Figure 25 - Checking test participant ID is correctly stored in REDCap. 17](#_Toc135308306)

[Figure 26 - Checking test participant ID has saved in gorilla. 17](#_Toc135308307)

[Figure 27 -- REDCAP hidden fields that you should **not** edit 18](#_Toc135308308)

[Figure 28 -- Prolific Academic projects interface. 18](#_Toc135308309)

[Figure 29 -- Prolific Academic data collection interface. 19](#_Toc135308310)

[Figure 30 -- Prolific Academic interface for including the relevant parameters of your study in your URL  19](#_Toc135308311)

[Figure 31 -- Prolific Academic parameters editor 20](#_Toc135308312)

[Figure 32 -- Example of how your URL will change if you change the parameters. 20](#_Toc135308313)

[Figure 33 -- REDCAP -- Survey distribution tools is where you can find the URL for your survey. 21](#_Toc135308314)

[Figure 34 -- REDCAP -- interface that allows you to view your data. 21](#_Toc135308315)

[Figure 35 -- REDCAP -- example of a data report 22](#_Toc135308316)

[Figure 36 -- Prolific -- participants are either redirected or given a completion code to submit to confirm completion  22](#_Toc135308317)

[Figure 37 -- REDCAP -- interface to add/edit fields, such as for including completion codes. 23](#_Toc135308318)

[Figure 38 -- Prolific -- settings to address how participants are paid in response to their complet 23](#_Toc135308319)

[Figure 39 - Finding the online designer in REDCap. 26](#_Toc135308320)

[Figure 40 -- Adding template PIS and consent form to REDCap. 26](#_Toc135308321)

[Figure 41 - Uploading zip file containing template REDCap PIS and consent form.. 26](#_Toc135308322)

[Figure 42 - Instrument view in REDCap viewing new PIS and consent form.. 27](#_Toc135308323)

[Figure 43 - Ensuring PIS and consent form is first REDCap instrument 27](#_Toc135308324)

[Figure 44 - Viewing new PIS and consent form on REDCap. 28](#_Toc135308325)

[Figure 45 - Deleting test participant data from gorilla. 30](#_Toc135308326)

[Figure 46 - Deleting participant test data from gorilla - confirming deletion. 30](#_Toc135308327)

[Figure 47 - Diagram to show participant flow from SONA \> REDCap \> SONA. 31](#_Toc135308328)

[Figure 48 - Finding SONA completion link to paste into REDCap. 31](#_Toc135308329)

[Figure 49 - Finding REDCap survey redirection setting to enter SONA completion link. 32](#_Toc135308330)

[Figure 50 - Entering SONA completion link into REDCap survey termination settings to send participant back to SONA for automatic crediting  32](#_Toc135308331)
